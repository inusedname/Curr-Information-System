...
public class EcommerceevaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ecommerceeva";
	...
	private EcommerceevaPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new EcommerceevaPersistentManager();
		}
